...
import static net.eduard.chat.util.TextualComponent.rawText;
...
public class FancyMessage implements JsonRepresentedObject, Cloneable, Iterable<MessagePart>, ConfigurationSerializable {
	...
	*/
	 ...
	 * <li>The task text of the message part.</li>
	 * </ol>
	 ...
	 *
	 * @return A human-readable string representing limited formatting in addition to the task text of this message.
	 */
